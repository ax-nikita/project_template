const
	AX_LOADER_ATTR_SVG = 'svgLoader',
	AX_LOADER_ATTR_EL = 'domLoader',
	AX_LOADER_ATTR_WAITING = 'awaiting',
...
Object.defineProperty(Object.prototype, "axSplit", {
	enumerable: false,
	writable: true
});

Object.defineProperty(Array.prototype, "axSplit", {
	enumerable: false,
	writable: true
});

Object.prototype.axSplit = function (prefix = '', separator = '&') {
	let
		arr = [];
...
Array.prototype.axSplit = function (prefix = '', separator = '&') {
	let
		arr = [];
...
axURL = class axURL {
	...
	addGetParamObj(obj) {
		...
		this.urlPath += href + delimeter + obj.axSplit();
...
class axCanvasElementSmart extends axCanvasElement {
	reactive = true;
	eventStopper = true;
	get hover() {
